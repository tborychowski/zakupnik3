...
function create_each_block_1(component, state) {
	...
	var if_block = (group.categories) && create_if_block(component, state);
...
// (11:6) {{#each group.categories as cat}}
...
// (10:6) {{#if group.categories}}
function create_if_block(component, state) {
	var row = state.row, each_value = state.each_value, idx = state.idx, group = state.group, each_value_1 = state.each_value_1, group_index = state.group_index;
	var each_anchor;

	var each_value_2 = group.categories;
...
function create_each_block(component, state) {
	...
	var tr, td, text_value = item.date.substr(0, 7), text, text_1, td_1, text_2_value = item.category.name, text_2, text_3, text_4_value = item.description, text_4, text_5, td_2, text_6_value = state.format(item.amount), text_6;
	...
	return {
		...
		p: function update(changed, state) {
			...
			if ((changed.data) && text_2_value !== (text_2_value = item.category.name)) {
